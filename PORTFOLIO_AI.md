...
또한 다른 프로젝트에서 AI를 활용하여 RAG와 같은 새로운 기술이 필요할 때 관련 지식과 구현 방법을 빠르게 학습하고 실제 서비스에 통합한 경험이 있습니다. 이러한 경험을 바탕으로 코코네에서도 새로운 AI 기능이나 실험을 신속하게 적용하고 초기 검증을 빠르게 진행하는 데 기여할 수 있을 것이라 생각합니다.
