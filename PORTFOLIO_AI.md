...
이러한 경험을 통해 AI와 함께 일하는 방식이 서비스 초기의 불확실성을 줄이고 실행력을 높이는 데 실질적인 도움이 된다는 것을 체감했습니다. 코코네처럼 방대한 유저 데이터와 서비스 맥락을 가진 환경에서는 이러한 의사결정 방식이 더 큰 효과를 낼 수 있다고 생각하며 초기 실험을 빠르게 현실로 만드는 역할로 기여하고 싶습니다.
